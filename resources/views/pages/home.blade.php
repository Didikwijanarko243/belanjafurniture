...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h1 class="font-display text-5xl lg:text-6xl leading-tight text-ink mb-6">
                    Rumah yang terasa hangat, dibuat dari kayu pilihan.
                </h1>
                <p class="text-ink/70 text-lg leading-relaxed mb-8 max-w-lg">
                    Setiap furniture kami dikerjakan tangan pengrajin lokal, dari pemilihan kayu hingga finishing akhir.
                </p>
    ...
    <section class="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <x-section-heading
            ...
            subtitle="Temukan furniture sesuai kebutuhan ruangan Anda." />
    ...
    <section class="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            @empty
                <p class="col-span-full text-ink/50 text-sm">
                    Belum ada produk unggulan. Set <code class="bg-walnut/10 px-1.5 py-0.5 rounded">is_featured</code> ke true di beberapa produk.
                </p>
            @endforelse
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <x-section-heading
            ...
            title="Dipercaya untuk mengisi rumah mereka"
            class="mx-auto" />
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            @empty
                <x-testimonial-card
                    name="Rina W."
                    role="Surabaya"
                    comment="Meja makannya kokoh dan seratnya cantik banget, sesuai foto."
                    :rating="5" />
                <x-testimonial-card
                    name="Andi P."
                    role="Malang"
                    comment="Pengiriman aman walau ukurannya besar, dikemas rapi."
                    :rating="5" />
                <x-testimonial-card
                    name="Dewi S."
                    role="Sidoarjo"
                    comment="Respon WhatsApp cepat, custom ukuran juga bisa."
                    :rating="4" />
            @endforelse
        </div>
    </section>
    ...
    <section class="bg-walnut-dark">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-16 text-center">
            <h2 class="font-display text-3xl text-canvas mb-4">
                Siap membuat rumah Anda lebih hangat?
            </h2>
            <p class="text-canvas/70 mb-8 max-w-lg mx-auto">
                Konsultasikan kebutuhan furniture Anda, gratis, lewat WhatsApp.
            </p>
